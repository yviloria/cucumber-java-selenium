...
public class loginHooksSteps {
    ...
    public void browserSetup(){
        System.out.println("browserSetup without order");
    ...
    public void tearDown(){
        System.out.println("tearDown without order");
        driver.close();
        driver.quit();
    }
    ...
    public void browserSetup2(){
        System.out.println("browserSetup 2");
    }
    ...
    public void user_enter_username_and_password(String username, String password) throws InterruptedException {
        pageLogin.enterUser(username); //pageLogin.enterUser();
        Thread.sleep(2000);
